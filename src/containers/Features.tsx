...
import shopify from "../../public/assets/icon-shopify.png";
import whatsappApi from "../../public/assets/icon-whatsapp-api.png";
import cart from "../../public/assets/icon-cart.png";
import review from "../../public/assets/icon-review-bubble.png";
import multimedia from "../../public/assets/icon-review-multimedia.png";
import apps from "../../public/assets/icon-review-apps.png";
