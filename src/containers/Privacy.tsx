      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Revio LTD, Varna, Bulgaria 9000.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Facebook Fan Page</strong> is a public profile named Revio -
            Conversational commerce App specifically created by the Company on
            ...
            <a
              ...
              target="_blank"
            >
              https://www.facebook.com/revioappforecommerce
            </a>
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Revio, accessible from{" "}
            <a
              href="https://getrevio.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://getrevio.com
        ...
        <li>
          <p>
            ...
            <a
              ...
              data-cfemail="08676e6e616b6d486f6d7c7a6d7e6167266b6765"
            >
              [email&#160;protected]
            </a>
          </p>
